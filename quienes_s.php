...
<html lang="en">
  <head>
    ...
    <script src="https://kit.fontawesome.com/6dbccfa671.js" crossorigin="anonymous"></script>
  ...
  <body>
    ...
    <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
      <div class="col-md-8 p-lg-5 mx-auto my-5">
        <h1 class="display-4 font-weight-normal" style="color: #ff7064">¿Quiénes somos?</h1>
        <p class="lead font-weight-normal"><b>Yo Reciclo y Tú Reciclas</b> nace de la necesidad de acercar el reciclaje a las personas que, por distintos motivos, no pueden salir de casa. El proyecto parte de la idea de hacer del reciclaje parte de la cultura de nuestro barrio, pueblo, ciudad y, por qué no, país. </p>

        <p class="lead font-weight-normal">Nuestra web es totalmente accesible a personas con discapacidades. No queremos que nadie nos pueda poner la excusa de no reciclar por falta de facilidades.</p>

        <p>
          <a class="btn btn-outline-secondary" style="color: #ff7064" data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">Conoce al equipo</a>
        </p>

        <div class="collapse" id="collapseExample">
          <div class="card card-body">
            <img src="img/DSC_8519.JPG" alt="Foto de José Miguel Sáez Teruel, CEO y fundador de Yo Reciclo y Tú Reciclas" class="img-fluid img-thumbnail mx-auto" style="width: 120px;"> <br>
            <h5>José Miguel Sáez Teruel</h5>
            <p>CEO y Fundador</p>
          </div>
        </div>
