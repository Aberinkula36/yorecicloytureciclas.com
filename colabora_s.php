  ...
  <body>
    ...
    <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
      <div class="col-md-6 p-lg-5 mx-auto my-5">
        <h1 class="display-4 font-weight-normal" style="color: #ff7064">Colabora</h1>
        <p class="lead font-weight-normal">Estamos seguros de que tienes mucho que aportar. En <b>Yo Reciclo y Tú Reciclas</b> siempre buscamos gente concienciada que ayude a propagar nuestro mensaje. </p>

        <p>
          <a class="btn btn-outline-secondary" style="color: #ff7064" data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">¡El planeta necesita de tu talento!</a>
        </p>

        <div class="collapse" id="collapseExample">
          <div class="card card-body">
            Elige tu sector y ponte en contacto con nosotros.
    ...
    <div class="mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden" style="background-color: #ff5493">
      <div class="my-3 py-3">
        ...
        <div class="bg-light shadow-sm mx-auto" style="width: 80%; height: 300px; border-radius: 21px 21px 0 0;">
          <img src="img/15.jpg" class="img-fluid" alt="Ciudad vista con objetivo de ojo de pez">
        </div>
      </div>
    </div>
