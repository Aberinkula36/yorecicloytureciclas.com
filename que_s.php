  ...
  <body>
    ...
    <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
      <div class="col-md-8 p-lg-5 mx-auto my-5">
        <h1 class="display-4 font-weight-normal" style="color: #ff5493">¿Qué hacemos?</h1>
        <p class="lead font-weight-normal">Nuestro sistema se basa en la colaboración ciudadana. <br>¿Cómo? Muy sencillo: <br> <br> Sólo tienes que <b>registrarte en nuestra web</b>, <b>elegir una hora</b> para que recojamos tu reciclaje y uno de nuestros recogedores realizará el servicio. Puedes solicitar nuestro servicio puntualmente o mediante una tarifa fija mensual, trimestral o anual. </p>
        
        <p>
          <a class="btn btn-outline-secondary" style="color: #ff5493" data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">Apoya nuestra acción</a>
        </p>

        <div class="collapse" id="collapseExample">
          <div class="card card-body">
            Puedes ver nuestros proyectos en marcha en nuestras Redes Sociales.
