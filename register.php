...
<html lang="en">
  ...
  <body>
    ...
    <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
      <h1 class="display-3 font-weight-normal" style="color: #ff5493">¡Vamos a reciclar!</h1>
      <div class="col-md-5 p-lg-5 mx-auto my-5 text-white" style="background-color: #ff7064">
        ...
        <form method="post" action="enviar.php">
          ...
          <div class="form-group">
            ...
            <input type="password" class="form-control" name="contraseña" id="contraseña" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="La contraseña debe tener al menos un número, una mayúscula y una minúscula y 8 o más caracteres" required>
          </div>

          <div class="form-group">
            <label for="contraseña2">Repita la contraseña</label>
            <input type="password" class="form-control" name="contraseña2" id="contraseña2" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required>
          </div>

          <div class="form-group">
            <label for="direccion">Dirección</label>
            <input type="text" class="form-control" name="direccion" id="direccion" placeholder="Carrer Ecuador 189" required>
          </div>

          <div class="form-group">
            <label for="direccion2">Dirección 2</label>
            <input type="text" class="form-control" name="direccion2" id="direccion2" placeholder="Piso, puerta, escalera...">
          </div>
          ...
          <div class="form-group">
            <div class="form-check">
              <input class="form-check-input" type="checkbox" id="18" required>
              <label class="form-check-label" for="18" required>
                Soy mayor de edad
              </label>
            </div>
          </div>
          <button type="submit" class="btn btn-lg" style="background-color: #ff5493; color: white">Registrarme</button>
        </form>
